    ...
    contents.append(
        {
            ...
            "parts": (
                ...
                '      "problem_statement": "<50 word problem summary. Mention why Samsung Research Institute(SRI) should focus on this>",\n'
                ...
                '- Each worklet must include a "reasoning" field capturing the LLM\'s rationale of why it chose this approach.\n'
